...
import { FramerMagnetic } from '../Magnetic';

// The Socials component renders a group of social media icons with a magnetic hover effect.
const Socials = () => {
  return (
    // Container for all social icons, arranged horizontally and centered.
    <div className="flex justify-center gap-8 flex-wrap">
      ...
      <FramerMagnetic>
        <Link href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">
          <svg
            ...
            viewBox="0 0 50 50"
            // Styling for the SVG icon, including size, color, and hover transition.
            className="w-[24px] h-[24px] md:w-[36px] md:h-[36px] fill-content-muted transition-colors duration-200 cursor-pointer hover:fill-flame-500"
          >
      ...
      {/* Facebook Icon - Wrapped in FramerMagnetic for the interactive effect. */}
      {/* <FramerMagnetic>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 30 60"
      ...
      {/* Twitter/X Icon - Wrapped in FramerMagnetic for the interactive effect. */}
      {/* <FramerMagnetic>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 55 45"
      ...
      {/* YouTube Icon - Wrapped in FramerMagnetic for the interactive effect. */}
      {/* <FramerMagnetic>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 50 35"
